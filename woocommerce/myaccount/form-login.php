        ...
        <?php endif; ?>
        		...
        		<form class="woocomerce-form woocommerce-form-login login register-form outer-top-xs" method="post">
        			...
        			<div class="form-row">
                        ...
                        <button type="submit" class="woocommerce-Button btn-upper btn btn-primary checkout-page-button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
        			</div>
        	...
        	<div class="col-md-6 col-sm-6 create-new-account">
        		...
        		<form method="post" class="register">
        			...
        			<p class="woocomerce-FormRow form-row">
        				...
        				<button type="submit" class="woocommerce-Button btn-upper btn btn-primary checkout-page-button" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
        			</p>
