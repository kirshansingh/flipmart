    ...
    <div class="panel-heading">
       <h4 class="unicase-checkout-title">
        <a data-toggle="collapse" class="collapsed" data-parent="#accordion-content" href="#collapseLogin">
        	...
        	<span>L</span> <?php echo __( 'Returning customer? Click here to login', 'flipmart' ); ?>
            <?php } ?>
        </a>
      </h4>
    </div>
		...
		<div class="shipping_address panel-body"> 
            <?php 
                woocommerce_login_form(
                	array(
                		'message'  => __( 'If you have shopped with us before, please enter your details in the boxes below. If you are a new customer, please proceed to the Billing &amp; Shipping section.', 'flipmart' ),
