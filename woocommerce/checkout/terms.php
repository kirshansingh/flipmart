...
if ( $terms_page_id > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) :
	...
	?>
	<p class="form-row terms wc-terms-and-conditions radio radio-checkout-unicase">
		...
		<label class="woocommerce-form__label woocommerce-form__label-for-checkbox radio-button guest-check">
