            ...
            <tr>
                <th>
                    ...
                    <?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
            			<div class="fee cart-grand-total row">
            		...
            		<?php if ( wc_tax_enabled() && 'excl' === WC()->cart->tax_display_cart ) :
            			...
            			if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) : ?>
            				<?php foreach ( WC()->cart->get_tax_totals() as $code => $tax ) : ?>
            					<div class="tax-rate tax-rate-<?php echo sanitize_title( $code ); ?> cart-grand-total row">
            				...
            				<?php endforeach; ?>
            			<?php else : ?>
            				<div class="tax-total cart-grand-total row">
			...
			<tr>
				<td>
					<div class="cart-checkout-btn pull-right">
                        ...
                        <span class=""><?php echo esc_html__( 'Checkout with multiples address!', 'flipmart' ); ?></span>
					</div>
				</td>
			</tr>
		</tbody>
