...
?>
	<link rel="shortcut icon" href="<?php yog_helper()->get_option_print( 'favicon.url', 'url', get_template_directory_uri() . '/assets/images/favicon.ico') ?>" />
	<?php
...
function yog_get_header_view() {
    ...
    if( $yog_site_version == 'v7' ){
        get_template_part( 'templates/header/header', 'v2' );
    }else{
...
function yog_wrapper_start() {
    ...
    //Wrapper Start.
    if( $yog_site_version == 'v7' ){
        echo '<div id="wrapper" class="site-wrapper fashion">';    
    }else{
