...
class Yog_Admin extends Yog_Base {
    ...
    public function enqueue() {
		...
		wp_enqueue_style( 'yog-admin', yog()->load_assets( 'css/yog-admin.css' ) );
		wp_enqueue_style( 'yog-redux', yog()->load_assets( 'css/yog-redux.css' ) );
		wp_enqueue_style( 'font-awesome', yog()->load_assets( 'css/font-awesome.min.css' ) );
		wp_enqueue_script( 'yog-admin', yog()->load_assets( 'js/yog-admin.js' ), array( 'jquery' ), false, true );
