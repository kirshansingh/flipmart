...
class Yog_Theme extends Yog_Base {
	...
	public function includes() {
        ...
        //Widgets.
        require_once( get_template_directory().'/theme/widgets/banner.php' );
        require_once( get_template_directory().'/theme/widgets/category-accordion.php' );
        require_once( get_template_directory().'/theme/widgets/contact-info.php' );
        require_once( get_template_directory().'/theme/widgets/post-tab.php' );
        require_once( get_template_directory().'/theme/widgets/product-hot-deals.php' );
        require_once( get_template_directory().'/theme/widgets/mega-menu.php' );
        require_once( get_template_directory().'/theme/widgets/testimonials.php' );
