 ...
 */
function flipmart_wp_search_size($queryVars) {
...
add_filter('request', 'flipmart_wp_search_size'); // Hook our custom function onto the

function yog_auto_search_js() {
    echo '
        <script>
            jQuery(function($){
...
add_action('wp_head', 'yog_auto_search_js');
...
function yog_add_name_woo_account_registration() {
    ...
    <div class="row">
        <div class="form-row form-row-first form-group col-md-6">
            ...
            <input type="text" class="input-text input-text form-control unicase-form-control" name="billing_first_name" id="reg_billing_first_name" value="<?php if ( ! empty( $_POST['billing_first_name'] ) ) esc_attr_e( $_POST['billing_first_name'] ); ?>" />
        </div>
        ...
        <div class="form-row form-row-last form-group col-md-6">
            ...
            <input type="text" class="input-text input-text form-control unicase-form-control" name="billing_last_name" id="reg_billing_last_name" value="<?php if ( ! empty( $_POST['billing_last_name'] ) ) esc_attr_e( $_POST['billing_last_name'] ); ?>" />
        </div>
    </div>
    <div class="clearfix"></div>
