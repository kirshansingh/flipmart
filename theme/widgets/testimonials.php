            ...
            <div id="advertisement" class="advertisement">
                 <?php 
                    ...
                    while ($yog_posts->have_posts()) {
                        ...
                        ?>
                        <div class="item">
                            <div class="avatar"><?php echo get_the_post_thumbnail( get_the_ID(), array( 110, 110), array( 'class' => 'alignleft' ) ); ?></div>
                            <?php 
                                 //Testimonial
                                 if( $yog_testimonial = get_post_meta( get_the_ID(), 'testimonial-content', true ) ){
                                    echo '<div class="testimonials"><em>"</em>'. esc_html( $yog_testimonial ) .'</div>';
                                 }
